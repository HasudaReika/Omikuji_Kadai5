...
<div class="field">
    <div>
        <h2>過去半年の運勢</h2>
        <canvas id="pastSixMonthsChart" width="400" height="400"></canvas>
    </div>
...
const pastSixMonthsCtx = document.getElementById("pastSixMonthsChart");
createChart(pastSixMonthsCtx, labels, data, '過去半年の運勢');

const todayCtx = document.getElementById("todayChart");
createChart(todayCtx, labels, data, '本日の運勢');
  </script>
